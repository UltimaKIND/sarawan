...
class Category(models.Model):
    ...
    parent = models.ForeignKey('self', verbose_name='родительская категория', related_name='childs', on_delete=models.CASCADE, **NULLABLE)
...
class Product(models.Model):
    ...
    first_image = models.ImageField(verbose_name='1-ое изображение продукта', **NULLABLE)
    second_image = models.ImageField(verbose_name='2-ое изображение продукта', **NULLABLE)
    third_image = models.ImageField(verbose_name='3-ое изображение продукта', **NULLABLE)
